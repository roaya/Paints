Public Class QueryExpensesByPeriod
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If RadioAllExpenses.Checked = True And CheckByPeriod.Checked = False Then
            Me.Cursor = Cursors.WaitCursor
            t.Rows.Clear()
            cmd.CommandText = "SELECT Expense_Category_Name AS '«”„ »‰œ«·„’—Ê›« ' , Expense_Name AS '«”„ «·„’—Ê›' , Expense_Value AS 'ﬁÌ„ Â' , Expense_Date AS ' «—ÌŒ «·„’—Ê›' , Employee_Name AS '«”„ «·„”∆Ê·' FROM Report_Expenses ORDER BY Expense_Category_Name"
            da.Fill(t)
            DataGridView1.DataSource = t
            TabControl1.SelectTab(1)
            Me.Cursor = Cursors.Default
        ElseIf RadioAllExpenses.Checked = True And CheckByPeriod.Checked = True Then
            Me.Cursor = Cursors.WaitCursor
            t.Rows.Clear()
            cmd.CommandText = "SELECT Expense_Category_Name AS '«”„ »‰œ«·„’—Ê›« ' , Expense_Name AS '«”„ «·„’—Ê›' , Expense_Value AS 'ﬁÌ„ Â' , Expense_Date AS ' «—ÌŒ «·„’—Ê›' , Employee_Name AS '«”„ «·„”∆Ê·' FROM Report_Expenses where expense_date between '" & d1.ToString("MM/dd/yyyy") & "' and '" & d2.ToString("MM/dd/yyyy") & "' ORDER BY Expense_Category_Name"
            da.Fill(t)
            DataGridView1.DataSource = t
            TabControl1.SelectTab(1)
            Me.Cursor = Cursors.Default
