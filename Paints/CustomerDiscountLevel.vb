Public Class CustomerDiscountLevel
    ...
    Private Sub BtnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSave.Click, MenuSave.Click
        Try
            ...
            ElseIf MaxDiscountPercent.Value <= 0 Then
                ...
                MaxDiscountPercent.BackColor = Color.Yellow
            ElseIf MaxDiscountCash.Value <= 0 Then
                cls.MsgComplete()
                MaxDiscountCash.Focus()
                MaxDiscountCash.BackColor = Color.Yellow
            Else
    ...
    Private Sub MaxDiscountPercent_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MaxDiscountPercent.Leave
        If MaxDiscountPercent.Value > 0 Then
    ...
    Private Sub MaxDiscountCash_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MaxDiscountCash.Leave
        If MaxDiscountCash.Value > 0 Then
