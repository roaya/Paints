...
#End Region
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If cmd.CommandText = "" Then MsgBox("لا توجد بيانات", "please enter missing data") : Exit Sub
        ...
        Else
            cls.MsgExclamation("لا توجد بيانات", "please enter missing data")
        End If
    ...
    Private Sub choseForm()
        selformula = ""
        If cmbItemID.SelectedIndex <> -1 Then
            selformula = "SELECT Category_Name AS 'اسم البند',Corporation_Name AS 'اسم الشركة',Item_Name AS 'اسم الصنف',Barcode AS 'الباركود',Purchase_price AS 'سعر الشراء',Sale_Price AS 'سعر القطاعي',Sale_Total_Price AS 'سعر الجمله',Um_Name AS 'مجموعة القياس' FROM Query_All_Items where Corporation_Name=N'" & (cmbItemID.Text) & "'"
