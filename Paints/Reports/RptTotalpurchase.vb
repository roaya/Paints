...
Public Class RptTotalpurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.RptTotalpurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTotalpurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTotalpurchase = New RptTotalpurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
