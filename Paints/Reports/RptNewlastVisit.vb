...
Public Class RptNewlastVisit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.RptNewlastVisit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptNewlastVisit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptNewlastVisit = New RptNewlastVisit()
        rpt.Site = Me.Site
        Return rpt
    End Function
