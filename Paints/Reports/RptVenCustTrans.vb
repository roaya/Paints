...
Public Class RptVenCustTrans
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.RptVenCustTrans.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptVenCustTrans
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptVenCustTrans = New RptVenCustTrans()
        rpt.Site = Me.Site
        Return rpt
    End Function
