...
Public Class RptSalesProfitCost
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.RptSalesProfitCost.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptSalesProfitCost
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSalesProfitCost = New RptSalesProfitCost()
        rpt.Site = Me.Site
        Return rpt
    End Function
