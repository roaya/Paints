...
Public Class StatMostDepAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.StatMostDepAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatMostDepAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatMostDepAll = New StatMostDepAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
