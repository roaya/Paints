...
Public Class Report_Det_Sal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.Report_Det_Sal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReport_Det_Sal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Det_Sal = New Report_Det_Sal()
        rpt.Site = Me.Site
        Return rpt
    End Function
