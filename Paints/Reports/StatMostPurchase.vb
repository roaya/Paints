...
Public Class StatMostPurchase
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.StatMostPurchase.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatMostPurchase
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatMostPurchase = New StatMostPurchase()
        rpt.Site = Me.Site
        Return rpt
    End Function
