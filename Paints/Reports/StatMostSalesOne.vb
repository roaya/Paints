...
Public Class StatMostSalesOne
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.StatMostSalesOne.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatMostSalesOne
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatMostSalesOne = New StatMostSalesOne()
        rpt.Site = Me.Site
        Return rpt
    End Function
