...
Public Class StatMostSalesAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.StatMostSalesAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatMostSalesAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatMostSalesAll = New StatMostSalesAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
