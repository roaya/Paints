...
Public Class SecondRptBarCode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.SecondRptBarCode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecondRptBarCode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SecondRptBarCode = New SecondRptBarCode()
        rpt.Site = Me.Site
        Return rpt
    End Function
