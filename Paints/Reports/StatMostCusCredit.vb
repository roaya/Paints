...
Public Class StatMostCusCredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Paints.StatMostCusCredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatMostCusCredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatMostCusCredit = New StatMostCusCredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
