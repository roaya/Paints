Public Class Insurance
    ...
    Dim BSourceInsurance As New BindingSource
    '-------------------------------
    'Set The Data Table Name
    Dim TName As String = "Insurance"
    Dim d As Date
    '-------------------------------
    ...
    Private Sub Customers_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Gcls = New GeneralSp.NewMasterForms(TName, BSourceInsurance, BtnNew, BtnSave, BtnDelete, BtnSearch, BtnExit, BtnReload, BtnCancelSerach, BtnFirst, BtnPrevious, BtnNext, BtnLast, BtnFile, BtnData, BtnHelp, OrderByCombo, ContentPanel, MasterField1, CountRecords, MenuNew, MenuSave, MenuDelete, MenuSearch, MenuExit)
            ...
            MasterField1.TextBox1.DataBindings.Add("Text", BSourceInsurance, "Insurance_Name")
            PercentFixedCompany.DataBindings.Add("Value", BSourceInsurance, "Percent_Fixed_Company")
            PercentFixedEmployee.DataBindings.Add("Value", BSourceInsurance, "Percent_Fixed_Employee")
            PercentVariableCompany.DataBindings.Add("Value", BSourceInsurance, "Percent_Variable_Company")
            PercentVariableEmployee.DataBindings.Add("Value", BSourceInsurance, "Percent_Variable_Employee")

            SSource = BSourceInsurance
    ...
    Private Sub OrderByCombo_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles OrderByCombo.SelectedIndexChanged
        Try
            If B_EndLoad = True Then
                Gcls.SortData(BSourceInsurance, OrderByCombo.SelectedValue)
            End If
        Catch ex As Exception
            cls.WriteError(ex.Message, TName)
        End Try
