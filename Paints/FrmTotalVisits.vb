Public Class FrmTotalVisits

    'Dim rpt As New RptNewlastVisit
    Private CmdObj, WhereStmt As String
    Dim b As Boolean = False
    Dim ResChk As Boolean
    Dim rpt2 As New RptNewlastVisit
    ...
    '        cmd.CommandText = " select * from report_total_sales where maximum_bill = (select max(maximum_bill) from report_total_sales)"
    '        da.Fill(MyDs.Tables("report_total_sales"))
    ...
    '            'Exit Sub
    '        Else
    '            cmd.CommandText = "Select * from report_total_sales where sum_bills > " & NumBill.Value
    '            da.Fill(MyDs.Tables("report_total_sales"))
    ...
    Private Sub FrmTotalSales_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        MyDs.Tables("report_New__last_Visits").Rows.Clear()
        DataGridView2.DataSource = MyDs.Tables("report_New__last_Visits")
        ...
        DataGridView2.Columns(11).HeaderText = "رقم الفيزا"
        DataGridView2.Columns(12).HeaderText = "اسم الموظف"

        DataGridView2.Columns(13).Visible = False
        DataGridView2.Columns(14).Visible = False
        DataGridView2.Columns(15).Visible = False
        DataGridView2.Columns(16).Visible = False
        DataGridView2.Columns(17).HeaderText = "اسم الجوله"
        DataGridView2.Columns(18).HeaderText = "اسم المندوب"
    ...
    Private Sub RadTotalBillBetween_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadTotalBillBetween.CheckedChanged
        If RadTotalBillBetween.Checked = True Then
            ...
            combvisits.Enabled = False
            combSalesRep.Enabled = False
        End If
    End Sub
    ...
    Private Sub RadMAxTBill_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadMAxTBill.CheckedChanged
        If RadMAxTBill.Checked = True Then
            combBillId.Enabled = False
            CombCheques.Enabled = False
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If RadCustomer.Checked = True Then
            ...
            If RadAllBills.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where customer_name =  N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
                End If
            ElseIf RadMAxTBill.Checked = True Then
                If CombCustomer.Text = "" Then
                    cls.MsgExclamation("من فضلك اختر اسم العميل")

                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Total_Bill = (select max(total_bill) from report_New__last_Visits) and {ثىيخق_Name=  N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadTotalBillBetween.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Total_Bill > " & NumTotalBill.Value & "and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
                End If
            ...
            ElseIf RadBillID.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Bill_id = " & combBillId.Text & " and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadBillByDate.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Bill_Date between '" & d1.ToString("MM/dd/yyyy") & "' and '" & d2.ToString("MM/dd/yyyy") & "' and customer_name =N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
                End If
            ...
            ElseIf RadChequeNumber.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where cheque_Number = " & CombCheques.Text & " and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadDeservedCheques.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where recieve_date < getdate() and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadAllCheques.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where cheque_Number is not null  and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))

                End If
            ElseIf Radvisits.Checked = True Then
                If CombCustomer.Text = "" Then
                    cls.MsgExclamation("من فضلك اختر اسم العميل")

                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where visit_Name= N'" & combvisits.Text & "' and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))

                End If
            ElseIf RadSalesRep.Checked = True Then
                If CombCustomer.Text = "" Then
                    MsgBox("من فضلك اختر اسم العميل")

                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Sales_Rep_Name= N'" & combSalesRep.Text & "'  and customer_name= N'" & CombCustomer.Text & "'"
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            'If MyDs.Tables("report_New__last_Visits").Rows.Count > 0 And CombCustomer.Text <> "" Then
            '    'For Each c As CheckBox In GroupBox3.Controls
            '    '    c.Checked = True
            '    'Next
        ...
        ElseIf RadAllCustomer.Checked = True Then
            ...
            If RadAllBills.Checked = True Then
                ...
                cmd.CommandText = "select * from report_New__last_Visits   "
                da.Fill(MyDs.Tables("report_New__last_Visits"))

            ElseIf RadMAxTBill.Checked = True Then

                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Total_Bill = (select max(total_bill) from report_New__last_Visits) "
                da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadTotalBillBetween.Checked = True Then
                If NumTotalBill.Value <= 0 Then
                    MsgBox("من فضلك ادخل قيمه")
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Total_Bill > " & NumTotalBill.Value
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
                End If
            ...
            ElseIf RadBillID.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Bill_id = " & combBillId.Text
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadBillByDate.Checked = True Then
                ...
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Bill_Date between '" & d1.ToString("MM/dd/yyyy") & "' and '" & d2.ToString("MM/dd/yyyy") & "' "
                da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf RadChequeNumber.Checked = True Then
                ...
                Else
                    cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where cheque_Number = " & CombCheques.Text
                    da.Fill(MyDs.Tables("report_New__last_Visits"))
                End If
            ElseIf RadDeservedCheques.Checked = True Then

                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where recieve_date < getdate() "
                da.Fill(MyDs.Tables("report_New__last_Visits"))


            ElseIf RadDesrevedBill.Checked = True Then

                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Bill_Status=N'منتوحه' "
                da.Fill(MyDs.Tables("report_New__last_Visits"))
            ElseIf RadAllCheques.Checked = True Then



                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where cheque_Number is not null  "
                da.Fill(MyDs.Tables("report_New__last_Visits"))
            ...
            ElseIf Radvisits.Checked = True Then
                ...
                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where visit_Name= N'" & combvisits.Text & "'"
                da.Fill(MyDs.Tables("report_New__last_Visits"))


            ElseIf RadSalesRep.Checked = True Then

                cmd.CommandText = "select *,(select logo from stocks where stock_id=" & ProjectSettings.CurrentStockID & ") as logo   from report_New__last_Visits where Sales_Rep_Name= N'" & combSalesRep.Text & "'"
                da.Fill(MyDs.Tables("report_New__last_Visits"))

            End If
            If MyDs.Tables("report_New__last_Visits").Rows.Count > 0 Then
                'For Each c As CheckBox In GroupBox3.Controls
                '    c.Checked = True
                'Next
    ...
    Private Sub RadCustomer_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadCustomer.CheckedChanged
        If RadCustomer.Checked = True Then
            ...
            cmd.CommandText = "select Visit_Name from report_New__last_Visits where customer_Name=  N'" & CombCustomer.Text & "'"
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                CombCheques.Items.Add(dr("Visit_Name"))
            Loop
            dr.Close()
            cmd.CommandText = "select Sales_Rep_Name from report_New__last_Visits where customer_Name=  N'" & CombCustomer.Text & "'"
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                CombCheques.Items.Add(dr("Sales_Rep_Name"))
            Loop
            dr.Close()
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        rpt2.SetDataSource(MyDs.Tables("report_New__last_Visits"))
    ...
    Private Sub RadAllCustomer_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadAllCustomer.CheckedChanged
        ...
        If RadAllCustomer.Checked = True Then
            ...
            cmd.CommandText = "select Bill_ID from report_New__last_Visits "
            dr = cmd.ExecuteReader
            Do While dr.Read = True
            ...
            cmd.CommandText = "select Cheque_Number from report_New__last_Visits where cheque_Number is not null "
            dr = cmd.ExecuteReader
            Do While dr.Read = True
            ...
            cmd.CommandText = "select Visit_Name from report_New__last_Visits "
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                CombCheques.Items.Add(dr("Visit_Name"))
            Loop
            dr.Close()
            cmd.CommandText = "select Sales_Rep_Name from report_New__last_Visits "
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                CombCheques.Items.Add(dr("Sales_Rep_Name"))
            Loop
    ...
    Private Sub CombCustomer_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CombCustomer.SelectedIndexChanged
        ...
        Else
            cmd.CommandText = "select Bill_ID from report_New__last_Visits where Customer_Name = N'" & CombCustomer.Text & "'"
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                combBillId.Items.Add(dr("Bill_ID"))
            Loop
            ...
            cmd.CommandText = "select Cheque_Number from report_New__last_Visits where cheque_Number is not null and Customer_Name = N'" & CombCustomer.Text & "'"
            dr = cmd.ExecuteReader
            Do While dr.Read = True
                CombCheques.Items.Add(dr("Cheque_Number"))
            Loop
    ...
    Private Sub RadAllCheques_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadAllCheques.CheckedChanged
        If RadAllCheques.Checked = True Then
            combBillId.Enabled = False
            CombCheques.Enabled = False
            NumTotalBill.Enabled = False
            combvisits.Enabled = False
    ...
    Private Sub VisitName_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles VisitName.CheckedChanged
        If VisitName.Checked = True Then
            rpt2.ReportDefinition.ReportObjects("VisitName1").ObjectFormat.EnableSuppress = False
            rpt2.ReportDefinition.ReportObjects("Text5").ObjectFormat.EnableSuppress = False
            DataGridView2.Columns(17).Visible = True


        Else
            rpt2.ReportDefinition.ReportObjects("VisitName1").ObjectFormat.EnableSuppress = True
            rpt2.ReportDefinition.ReportObjects("Text5").ObjectFormat.EnableSuppress = True
            DataGridView2.Columns(17).Visible = False
        End If
    End Sub

    Private Sub SalesRepName_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SalesRepName.CheckedChanged
        If SalesRepName.Checked = True Then
            rpt2.ReportDefinition.ReportObjects("salesrepName1").ObjectFormat.EnableSuppress = False
            rpt2.ReportDefinition.ReportObjects("Text16").ObjectFormat.EnableSuppress = False
            DataGridView2.Columns(18).Visible = True


        Else
            rpt2.ReportDefinition.ReportObjects("salesrepName1").ObjectFormat.EnableSuppress = True
            rpt2.ReportDefinition.ReportObjects("Text16").ObjectFormat.EnableSuppress = True
            DataGridView2.Columns(18).Visible = False
        End If
    End Sub
    Private Sub Radvisits_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Radvisits.CheckedChanged
        If Radvisits.Checked = True Then
            combBillId.Enabled = False
            CombCheques.Enabled = False
            NumTotalBill.Enabled = False
            combvisits.Enabled = True
            combSalesRep.Enabled = False
        End If
    End Sub

    Private Sub RadSalesRep_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RadSalesRep.CheckedChanged
        If RadSalesRep.Checked = True Then
            combBillId.Enabled = False
            CombCheques.Enabled = False
            NumTotalBill.Enabled = False
            combvisits.Enabled = False
            combSalesRep.Enabled = True
        End If
    End Sub
