    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            If AddedValue.Value = 0 Then
                cls.MsgExclamation("ÇÏÎá ÇáÚÏÏ ÇáãÑÇÏ ØÈÇÚÊå", "enter number of printed items")
            ElseIf SourceList.SelectedItem Is Nothing Then
                cls.MsgExclamation("ÇÏÎá ÇáÕäÝ ÇáãÍÏÏ", "please enter item name")
            Else
                If ItemsCount.Text + AddedValue.Value > CInt(MyDs.Tables("App_Preferences").Rows(0).Item("Gen_Print_Barcode")) Then
                    cls.MsgExclamation("ÇáÇÕäÇÝ ÇáãÖÇÝÉ ÇßÈÑ ãä ÇáßãíÉ ÇáãÍÏÏÉ", "number of items if bigger than allowed items")
                Else
