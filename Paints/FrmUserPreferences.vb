Public Class FrmUserPreferences
    ...
    Private Sub FrmUserPreferences_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            GenMainScreen.DataBindings.Add("Text", BSourceAppPref, "Gen_Main_Screen")
            ComboHelpSystem.DataBindings.Add("Text", BSourceAppPref, "Gen_Assistant_Type")
...
l:
            ...
            If OpenFileDialog1.ShowDialog() = DialogResult.Cancel Then
                AssistantSound.Speak("background image hasnot been selected do you want to select another image file")
    ...
    Private Sub Button12_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button12.Click
        ...
        Try
            AssistantSound.Speak("please enter system password")
