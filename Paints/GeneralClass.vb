    ...
    Public Class GeneralClass
        ...
        Public Sub OpenConn(ByVal DB As String, ByVal RptSerName As String, Optional ByVal Usr As String = "Sa", Optional ByVal Pwd As String = "pass@word1", Optional ByVal IsLocal As Boolean = True)
            ...
            Else
                ...
                If CheckDatabaseAttached("Paints") = False Then
                    If My.Computer.FileSystem.FileExists(My.Application.Info.DirectoryPath & "\Paints.mdf") = True Then
                        AttachDatabase()
                    Else
...
#Region "DBAttach"
        ...
        Public Sub AttachDatabase()
            If CheckDatabaseAttached("Paints") = False Then
                ...
                DBData = My.Application.Info.DirectoryPath & "\Paints.mdf"
                DBLog = My.Application.Info.DirectoryPath & "\Paints_log.ldf"

                'cmd.CommandText = "sp_attach_db " & RptDB & ",'" & DBData & "'" & ",'" & DBLog & "'"
                cmd.CommandText = "CREATE DATABASE [Paints] ON (FILENAME = N'" & DBData & "' ),( FILENAME = N'" & DBLog & "' ) FOR ATTACH"
                cmd.ExecuteNonQuery()
            End If
        End Sub
